...
form.addEventListener('submit',function(e) {
  e.preventDefault();
  //Define variables inside form
  const value =  amount.value;
  const random = Math.floor(Math.random() * text.length);

  //shows the term 'string'
  //Black font will be shown in the console
  console.log(typeof value);
  console.log(value);

  //shows the term NaN or an actual number
  //Blue font will be shown in the console
